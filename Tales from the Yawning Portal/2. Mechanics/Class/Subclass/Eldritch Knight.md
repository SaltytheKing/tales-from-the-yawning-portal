The archetypal Eldritch Knight combines the martial mastery common to all [[Fighter]]s with a careful study of magic. Eldritch Knights use magical techniques similar to those practiced by [[Wizard]]s. They focus their study on two of the eight schools of magic—abjuration and evocation. Abjuration spells grant an Eldritch Knight additional protection in battle, and evocation spells deal damage to many foes at once, extending the [[Fighter]]'s reach in combat. These knights learn a comparatively small number of spells, committing them to memory instead of keeping them in a spellbook.

[[Fighter]] [[Subclass]] from [[Player's Handbook '14]]
#class #subclass #PHB14 
...
For example, if you know the 1st-level spell [[Shield (Spell)]] and have a 1st-level and a 2nd-level spell slot available, you can cast [[Shield (Spell)]] using either slot.
