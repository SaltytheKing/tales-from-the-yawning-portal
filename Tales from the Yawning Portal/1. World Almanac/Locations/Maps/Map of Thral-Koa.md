...
```leaflet  
id: Thral-KoanMap ### Must be unique with no spaces  
image: [[TftYP Campaign Map Compressed.png]] ### Link to the map image file. Do not add a ! in front of the image  
...
lat: 2000 ### To center the map, make this half of the map height.  
